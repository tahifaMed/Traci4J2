...
implements StepAdvanceListener
{
	...
	public Integer getTimeStepEnter() {
		return timeStepEnter;
	}



	public void setTimeStepEnter(Integer timeStepEnter) {
		this.timeStepEnter = timeStepEnter;
	}
	...
	Vehicle (
		...
		addReadQuery(Variable.WAITING_TIME, 
				new ReadObjectVarQuery.DoubleQ (dis, dos, 
				it.polito.appeal.traci.protocol.Constants.CMD_GET_VEHICLE_VARIABLE, 
				id, 
				it.polito.appeal.traci.protocol.Constants.VAR_WAITING_TIME
	...
	public void nextStep(double step) {
		...
		getReadQuery(Variable.WAITING_TIME).setObsolete();
	 ...
	 * @return the instance of {@link ReadObjectVarQuery} relative to this query.
	 */
	public ReadObjectVarQuery<java.lang.Double> queryWaitingTime() {
		return (ReadObjectVarQuery.DoubleQ) getReadQuery(Variable.WAITING_TIME);
	}
