...
import it.polito.appeal.traci.Lane.Variable;
...
implements StepAdvanceListener
{
	...
	Edge (
		...
		addReadQuery(Variable.LAST_STEP_HALTING_NUMBER, 
				new ReadObjectVarQuery.IntegerQ (dis, dos, 
				it.polito.appeal.traci.protocol.Constants.CMD_GET_EDGE_VARIABLE, 
				id, 
				it.polito.appeal.traci.protocol.Constants.LAST_STEP_VEHICLE_HALTING_NUMBER
	...
	public void nextStep(double step) {
		...
		getReadQuery(Variable.LAST_STEP_HALTING_NUMBER).setObsolete();
	...
	public ReadObjectVarQuery<Integer> queryReadLastStepHaltingNumber() {
		return (ReadObjectVarQuery.IntegerQ) getReadQuery(Variable.LAST_STEP_HALTING_NUMBER);
	}
